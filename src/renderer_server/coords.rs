...
impl ScreenPoint {
    ...
    pub fn from_logical(point: Point, dpi_scale: f64, center: Point, fb_center: ScreenPoint) -> Self {
        let Point { x, y } = point;
...
mod tests {
    ...
    fn screen_coords() {
        ...
        let screen_coord = ScreenPoint::from_logical(
            Point { x: 10.0, y: 20.0 },
            1.0,
            Point { x: 30.0, y: 5.0 },
            ScreenPoint { x: 200.0, y: 300.0 },
        );
    ...
    fn logical_coords() {
        ...
        // Negative points work too
        let logical_coord =
            ScreenPoint { x: 160.0, y: 315.0 }.to_logical(1.0, Point { x: 30.0, y: -5.0 }, ScreenPoint { x: 200.0, y: 300.0 });
        assert_eq!(logical_coord, Point { x: -10.0, y: -20.0 });
