use crate::ipc_protocol::{PenProp, PenPropValue, ServerOneshotSender, ServerResponse, TurtleProp, TurtlePropValue};
...
pub(crate) fn turtle_prop(conn: ServerOneshotSender, app: &App, id: TurtleId, prop: TurtleProp) -> Result<(), HandlerError> {
...
pub(crate) fn set_turtle_prop(
    ...
    match prop_value {
        ...
        Position(_) | PositionX(_) | PositionY(_) => unreachable!("bug: should have used `MoveTo` instead"),
